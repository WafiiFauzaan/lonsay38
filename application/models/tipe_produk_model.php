...
class tipe_produk_model extends CI_Model {
	...
	public function insert($input) {
		...
		return $this->db->insert('tipe_produk', $input);
	}
	...
	public function update($input, $id) {
		...
		//$input = data yang dikirim dari controller
		return $this->db->update('tipe_produk', $input);
	...
	public function delete($id) {
		...
		$this->db->where('id', $id);
		return $this->db->delete('tipe_produk');
