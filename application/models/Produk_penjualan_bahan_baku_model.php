...
class Produk_penjualan_bahan_baku_model extends CI_Model {
	...
	public function read($produk_id) {
		...
		$this->db->where('produk_penjualan_bahan_baku.produk_id', $produk_id);
        $this->db->order_by('produk_penjualan_bahan_baku.id DESC');
    	$query = $this->db->get();
	...
	public function insert($input) {
		...
		return $this->db->insert('produk_penjualan_bahan_baku', $input);
	}
	...
	public function update($input, $id) {
		...
		//$input = data yang dikirim dari controller
		return $this->db->update('produk_penjualan_bahan_baku', $input);
	}
	...
	public function delete($id) {
		...
		$this->db->where('id', $id);
		return $this->db->delete('produk_penjualan_bahan_baku');
	}
}
